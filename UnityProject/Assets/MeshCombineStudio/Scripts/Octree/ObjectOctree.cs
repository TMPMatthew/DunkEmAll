...
namespace MeshCombineStudio
{
    ...
    public class FoundCombineConditions
    {
        ...
        public int matCount, lightmapIndexCount, shadowCastingCount, receiveShadowsCount, receiveGICount, lightProbeUsageCount, reflectionProbeUsageCount, probeAnchorCount;
