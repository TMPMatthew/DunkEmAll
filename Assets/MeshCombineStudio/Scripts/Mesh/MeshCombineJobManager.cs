            ...
            public void CreateMesh()
            {
                ...
                if (!Application.isPlaying)
                {
                    if (meshCombiner.copyBakedLighting)
                    {
                        ...
                        // lightmapSettings.lightmapIndex = meshObjectHolder.lightmapIndex;
                    }
                }
#endif
                ...
                if (meshCombiner.twoSidedShadows && meshCombineJob.backFaceTrianglesRemoved > 0) mr.shadowCastingMode = UnityEngine.Rendering.ShadowCastingMode.TwoSided;
